...
import AlmacenDatos.DBContarLacteos;
 ...
 * @author jsarango
 */
public class FrmAbrirPeridoConteoLacteos extends javax.swing.JFrame {

    DefaultTableModel modelo;

    public FrmAbrirPeridoConteoLacteos() {
        try {
    ...
    private void initComponents() {
        ...
        setTitle("Aperturar Conteo Lacteos");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ListaCajas = DBContarLacteos.mostrarConteoLacteosPeriodo(PeriodoAbrir);
            if (ListaCajas.isEmpty()) {
                ...
                if (Respuesta == 0) {
                    try {
                        ...
                        ListaInicio = DBContarLacteos.AbrirPeriodoConteo(PeriodoAbrir);
                        if (ListaInicio == null) {
                            ...
                            for (ContarCajas contar : ListaInicio) {
                                ...
                                DBContarLacteos.AgregarDiaConteo(ccajas);
                                CagarConteoLacteos(PeriodoAbrir);
                            }
                        }
                    } catch (SQLException ex) {
                        Logger.getLogger(FrmAbrirPeridoConteoLacteos.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            } else {
                CagarConteoLacteos(PeriodoAbrir);
    ...
    private void CagarConteoLacteos(String periodo) {
        //Boticas cDescargo;
        ...
        try {
            List<ContarCajas> ListaGrupos = DBContarLacteos.mostrarConteoLacteosPeriodo(periodo);
    ...
    private void btnAgregarTrabajadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarTrabajadorActionPerformed
        ...
        try {
            ...
            DBContarLacteos.AgregarDiaConteo(newTrabajador);
