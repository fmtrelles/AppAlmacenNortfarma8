 ...
 * @author jsarango
 */
public class FrmContarLacteos extends javax.swing.JFrame {

    DefaultTableModel modelo;

    public FrmContarLacteos() {
        try {
    ...
    private void btnRegistrarInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarInformacionActionPerformed
        ...
        CagarConteoLacteos(Integer.parseInt(txtDia.getText()), PeriodoAbrir);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (seleccion == 0) {
            ...
            for (int fil = 0; fil < jConteoMedicina.getRowCount(); fil++) {
                ...
                try {
                    DBContarLacteos.ActualizarDiaConteo(Integer.parseInt(txtDia.getText()), PeriodoActual, jConteoMedicina.getValueAt(fil, 3).toString(), contar);

                } catch (SQLException ex) {
                    Logger.getLogger(FrmContarLacteos.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void CagarConteoLacteos(int dia, String periodo) {
        //Boticas cDescargo;
        ...
        try {
            List<ContarCajas> ListaGrupos = DBContarLacteos.mostrarConteoLacteosDia(dia,periodo);
